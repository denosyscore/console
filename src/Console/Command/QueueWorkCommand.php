...
Examples:
  php core queue:work                    # Process jobs continuously
  php core queue:work --once             # Process one job then exit
  php core queue:work --queue=emails     # Process specific queue
HELP);
    }
