...
Usage:
  php core stubs:publish              # Publish ALL stubs
  php core stubs:publish migration    # Publish only migration stubs
  php core stubs:publish controller   # Publish only controller stubs
  php core stubs:publish model        # Publish only model stub
  php core stubs:publish provider     # Publish only provider stub
  php core stubs:publish command      # Publish only command stub
  php core stubs:publish middleware   # Publish only middleware stub
  php core stubs:publish request      # Publish only request stub
